...
<meta http-equiv="refresh" content="600"><title>Seasaw LB trajectory</title>
...
</head><body><h1>Seasaw — LB trajectory</h1>
...
<img src="{image_name}" alt="LB trajectory after Final Submission Deadline">
<h2>Latest values</h2><table><thead><tr><th>Submission</th><th>Episodes</th><th>Latest score</th><th>Latest episode time</th></tr></thead><tbody>{rows}</tbody></table>
